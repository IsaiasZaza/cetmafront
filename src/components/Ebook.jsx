...
const Ebook = () => {
  ...
  return (
    <div>
      <Header />
      {/* Hero Section */}
      <section className="relative bg-mobile-padrao lg:bg-ebooks bg-cover bg-center h-[50vh] sm:h-[60vh] md:h-[50vh] lg:h-[55vh] text-white flex flex-col justify-center items-start px-6 md:px-20 lg:px-40">
